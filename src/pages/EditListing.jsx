...
function EditListing() {
        ...
        const fetchUserListing = async () =>{
            ...
            if(!checkingStatus){
                if(!loggedIn){
                    ...
                    if(listingSnap.exists() && listingSnap.data().userRef===auth.currentUser.uid){
                        console.log("listing is: ", listingSnap.data())
                        //Can not use Listing after set, not yet changes, therefor must use listingSnap.data()
                        setFormData({...listingSnap.data(), address: listingSnap.data().location, longitude: listingSnap.data().geolocation.long, latitude: listingSnap.data().geolocation.lat})
                        setLoading(false)
                    }
                    else{
                        setLoading(false)
                        toast.error("No such user's listing")
                        navigate('/profile')
                    }
                }
            }
    ...
    <div className='profile'>
      <header>
        <p className="pageHeader">Update your Listing</p>
      </header>
